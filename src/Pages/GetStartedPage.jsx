...
const GetStartedPage = () => {
    ...
    return (
        <section className={`pt-[7%] flex flex-col gap-7 select-none w-full h-full overflow-hidden`}>
            ...
            {/* texts */}
            <div className={`h-[20%] flex flex-col items-center gap-4 overflow-hidden`}>
                <p ref={DetailTxtRef}
                    style={{
            ...
            <div className={`w-full h-[35%] flex flex-col items-center justify-center gap-3 overflow-hidden`}>
